...
**v2.4.0**). Start with the core spec; the rest are normative companions referenced from it.
...
All specs are `status: ratified`, `standard_version: 2.4.0`. Changes go through the LIP process
