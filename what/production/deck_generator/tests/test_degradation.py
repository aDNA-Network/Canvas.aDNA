"""Degradation: stripping _reserved yields a valid baseline (Obsidian) canvas — incl. isStartNode."""
...
def test_start_node_survives_strip(doc):
    ...
    assert len(start) == 1 and start[0]["id"] == "slide0"  # Extended field, valid post-strip
