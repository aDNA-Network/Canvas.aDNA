...
def json_schema() -> dict[str, Any]:
    """Return the published v2.4.0 JSON Schema (the structural contract; semantic checks are in the validator)."""
...
def _cli(argv: list[str] | None = None) -> int:
    ...
    p = argparse.ArgumentParser(prog="canvas-std", description="aDNA Canvas Standard v2.4.0 reference tooling")
    ...
    sub.add_parser("schema", help="print the v2.4.0 JSON Schema")
